...
QPushButton {{ border: 0; border-radius: 8px; padding: 8px 14px; font-size: 13px; }}
...
QLineEdit, QComboBox, QTimeEdit, QDoubleSpinBox, QSpinBox {{ background: #fbfcfe; border: 1px solid {BORDER}; border-radius: 8px; padding: 7px 9px; min-height: 18px; }}
